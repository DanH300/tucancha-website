...
class Live_events_model extends CI_Model {
    ...
    public function get_by_id($id) {
        ...
        $data = apiCall("event/get_by_id", array('id' => $id));

        if($data->content){
           
            $data = $this->rows(array($data->content));
        }
        return $data;
    ...
    public function subscription_checkout($data) {
        ...
        $order = apiPost("event/event_subscription_checkout", $parameters);
        return $order;
    }
    ...
    public function subscription_mobile_checkout($data) {
        ...
        $order = apiPost("event/event_subscription_mobile_checkout", $parameters);
        return $order;
    }
    ...
    public function buy_event_by_stored_cc($data){
        ...
        return apiPost("event/buy_event_by_stored_cc", $parameters);
    }

    function rows($data){
        $rows = array();
        // debug($data->content->entries);
