...
<head>
    ...
    <script>
        ...
        fbq('init', '443286463300228');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=443286463300228&ev=PageView&noscript=1" /></noscript>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo "/assets/theme/" . UVOD_THEME . "/css/dc.css?rev=" . time() . "" ?>" />
