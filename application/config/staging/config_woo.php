...
$config['twitter_url'] = '';
$config['ig_url'] = 'https://www.instagram.com/wooloo.tv/';

$config['streams_md5_shared_secret'] = '900P@rkCenter456';


$config['pixellot_sdk_url'] = 'https://pixellot-web-sdk.stage.pixellot.tv/5dd3ebb3fc43890010c3d341/v1.2.1/pixellot-web-sdk.js';
