...
//CDN
$config['fb_url'] = 'https://www.facebook.com/pixellotLtd/';
$config['twitter_url'] = 'https://twitter.com/pixellotltd';
$config['ig_url'] = '';

$config['streams_md5_shared_secret'] = '900P@rkCenter456';

$config['pixellot_sdk_url'] = 'https://pixellot-web-sdk.pixellot.tv/5d4d20f61b82ac0010ce91dc/v1.2.3/pixellot-web-sdk.js';
