...
//CDN
$config['fb_url'] = 'https://facebook.com/SkyLineSkyBest';
$config['twitter_url'] = '';
$config['ig_url'] = 'https://www.instagram.com/skyline.skybest/';

$config['streams_md5_shared_secret'] = '900P@rkCenter456';

$config['website_title'] = 'SkyZhone Sports';
$config['website_description'] = 'SkyZhone Sports OTT';
$config['pixellot_sdk_url'] = 'https://pixellot-web-sdk.pixellot.tv/5e1735ac8afed1001111d406/v1.4.2/pixellot-web-sdk.js';
