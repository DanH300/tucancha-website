...
$config['twitter_url'] = '';
$config['ig_url'] = 'https://www.instagram.com/maccabitlv_youth/';

$config['streams_md5_shared_secret'] = '900P@rkCenter456';

$config['pixellot_sdk_url'] = 'https://pixellot-web-sdk.pixellot.tv/5e3987b5b204a3003404dc6e/v1.2.8/pixellot-web-sdk.js';
