uvodApp.directive('jwplayerlive', function() {
    return {
        restrict: 'E',
        transclude: true,
        scope: {
        ...
        controller: ['$scope', '$rootScope', '$log', '$filter', function jwpCtrl($scope, $rootScope, $log, $filter) {
                ...
                $scope.setupVideo = function(vid, $filter) {
                    ...
                    if (vid) {
                        ...
                        if (sources.length) {
                            ...
                            if (publisherId != "") {
                                if (!$rootScope.adPlayers) {
                                    $rootScope.adPlayers = {};
                                }
                                if (!$rootScope.adPlayers[vid._id]) {
                                    var adData = {
                                    ...
                                    $rootScope.adPlayers[vid._id] = player;
                                    ...
                                    if (!$scope.playCalled) {
                                        $rootScope.adPlayers[vid._id].play();
            ...
            $scope.getPosterUrl = function(vid) {
                var livePoster = '';
                if (vid.ChannelLogoLarge) {
                    livePoster = vid.ChannelLogoLarge.url || vid.ChannelLogoLarge.downloadUrl;
                }
                return livePoster;
            }
        }],
        ...
        templateUrl: '/assets/theme/tuc/html/directives/jw-player-live.html'
    };
})